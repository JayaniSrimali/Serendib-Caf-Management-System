            ...
            <div className="w-full max-w-[900px] h-auto md:h-[600px] bg-theme-card rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden relative z-10 border-0">
                ...
                <div className="w-full md:w-1/2 h-full p-8 lg:p-12 flex flex-col justify-center bg-theme-bg relative">
                    ...
                    <div className="w-full md:mt-10">
                        <h2 className="text-[20px] font-bold text-theme-text mb-1.5 text-center md:text-left">Forgot Password?</h2>
                        <p className="text-theme-textMuted text-[12px] mb-8 text-center md:text-left md:pr-4">Enter your registered email address below and we will send you a link to reset your password.</p>
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-[12px] text-theme-textMuted inline">Remembered your password? </p>
                            <Link to="/login" className="text-theme-accent hover:text-theme-accentDark hover:underline text-[12px] font-bold border-b border-transparent hover:border-theme-accentDark pb-0.5 transition-all">Back to Login</Link>
                        </div>
                    </div>
                </div>
            </div>
